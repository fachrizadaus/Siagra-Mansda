...
<div class="container-fluid">
    ...
    function myFunction() {
        ...
        window.location.href = "index_guru.php?directionPage=jadwalPelajaran&activeState="+activeState+"&selectedRes="+x;
    ...
    <div class="table-data__tool">
        <div class="table-data__tool-left">
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item">
                    <a class="navlink <?php echo "$aa"; ?>" id="pills-home-tab" data-toggle="pill" href="index_guru.php?directionPage=jadwalPelajaran&activeState=X" role="tab" aria-controls="pills-home" aria-selected="true">X</a>
                </li>
                <li class="nav-item">
                    <a class="navlink <?php echo "$bb"; ?>" id="pills-profile-tab" data-toggle="pill" href="index_guru.php?directionPage=jadwalPelajaran&activeState=XI" role="tab" aria-controls="pills-profile" aria-selected="false">XI</a>
                </li>
                <li class="nav-item">
                    <a class="navlink <?php echo "$cc"; ?>" id="pills-contact-tab" data-toggle="pill" href="index_guru.php?directionPage=jadwalPelajaran&activeState=XII" role="tab" aria-controls="pills-contact" aria-selected="false">XII</a>
                </li>
            </ul>
        </div>
    </div>
