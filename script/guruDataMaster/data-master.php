    ...
    <div class="table-data__tool">
        <div class="table-data__tool-left">
            <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                <li class="nav-item">
                    <a class="navlink <?php echo "$aa"; ?>" id="pills-home-tab" data-toggle="pill" href="index_guru.php?directionPage=dataMaster&activeState=dataGuru" role="tab" aria-controls="pills-home" aria-selected="true">Data Guru</a>
                </li>
                <li class="nav-item">
                    <a class="navlink <?php echo "$bb"; ?>" id="pills-profile-tab" data-toggle="pill" href="index_guru.php?directionPage=dataMaster&activeState=dataSiswa" role="tab" aria-controls="pills-profile" aria-selected="false">Data Siswa</a>
                </li>
                <li class="nav-item">
                    <a class="navlink <?php echo "$cc"; ?>" id="pills-contact-tab" data-toggle="pill" href="index_guru.php?directionPage=dataMaster&activeState=dataKelas" role="tab" aria-controls="pills-contact" aria-selected="false">Data Kelas</a>
                </li>
            </ul>
        </div>
