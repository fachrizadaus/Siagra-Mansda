<form class="" action="" method="post">
    ...
    <div class="form-group">
        <div class="row">
            ...
            <div class="col-sm-8">
                <input value="" placeholder="" id="old_pass" type="password" name="old_pass" class="au-input--w300 au-input--style2"> <br>
        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                <input value="" placeholder="" id="new_pass" type="password" name="new_pass" class="au-input--w300 au-input--style2"> <br>
        ...
        <div class="row">
            ...
            <div class="col-sm-8">
                <input value="" placeholder="" id="conf_new_pass" name="conf_new_pass" type="password" class="au-input--w300 au-input--style2"> <br>
                <small class="text-muted" id="repeat_newpasswd">Ulangi Kata Sandi Baru Anda</small>
            </div>
        </div>
    </div>
    <input type="submit" name="simpan" value="Simpan" class="au-btn au-btn-icon au-btn--purple au-btn--small">
...
if (isset($_POST['simpan'])) {
    ...
    if (($kataSandiLama || $kataSandiBaru || $confKataSandi) == "") {
        ?>
        <script type="text/javascript">
            alert("Isi Form Terlebih Dahulu!");
        </script>
        <?php
    } else if ($kataSandiBaru !== $confKataSandi) {
        ?>
        <script type="text/javascript">
        ...
        $querySlcAkunAdmin = "select * from akun where username like '$data2[NIS]'";
        ...
        if ($cnt == 1) {
            if ($exist['password'] == $kataSandiLama) {
                $queryUpdatePassAdmin = "update akun set password = '$kataSandiBaru' where username = '$data2[NIS]'";
